function startCountdown(block, gameDate) {
  ...
  const timeElement = block.querySelector(".game-time-counter-elapsed");
    ...
    .then((data) => {
      ...
      if (isInitialized) {
        ...
        if ((didHomeScore || didAwayScore) && goalText) {
          const goalElement = block.querySelector(
            ".soccer-block-goal-notification",
          );
          if (goalElement) {
          ...
          const scoreContainer = block.querySelector(
            ".soccer-block-score-content",
          );
          if (scoreContainer) {
      ...
      if (!isInitialized) {
                ...
                <div class="soccer-block-score">
                    <div class="soccer-block-score-content">
                        ...
                        <div class="soccer-block-score-content-time game-time-counter"> 
                            <span>${!dataTeam?.status?.elapsed ? dataTeam?.status?.long : ""}</span>
                            <span class="game-time-counter-elapsed">${
        ...
        const scoreElements = block.querySelectorAll(
          ".soccer-block-score-content-scoreboard",
        );

...
if (GProdemiSettings.blocks.linksBlock) {
  registerBlockType("gprodemi/links-block", {
    ...
    attributes: {
      links: {
        type: "array",
        default: [{ titulo: "Clique aqui", url: "#" }],
      },
      redirect: {
        type: "boolean",
        default: false,
    ...
    edit: ({ attributes, setAttributes, clientId }) => {
      ...
      const addLink = () => {
        setAttributes({
          links: [...links, { titulo: "Clique aqui", url: "#" }],
        });
      };
          ...
          ...links.map((link, index) =>
            createElement(
              "a",
              {
                key: index,
                href: link.url,
                className: "block-linksInternos-a",
                target: "_blank",
              },
              link.titulo
            )
        ...
        ...links.map((link, index) =>
          createElement(
            "a",
            {
              key: index,
              href: link.url,
              className: "linksInternos-a",
              target: targetLocation(attributes.redirect),
            },
            link.titulo
          )
        ),
    ...
    edit: ({ attributes, setAttributes, clientId }) => {
      ...
      return createElement(
        ...
        createElement(
          ...
          createElement(
            "div",
            { className: "blocoApps-textos" },
            createElement(
              "span",
              { className: "blocoApps-t1" },
              attributes.subtitle
            ),
            createElement(
              "span",
              { className: "blocoApps-t2" },
              attributes.title
            ),
            createElement(
              "span",
              { className: "blocoApps-t3" },
              attributes.description
            ),
            createElement(
              "a",
              { className: "block-blocoApps-link", href: attributes.link },
              attributes.cta
            ),
            createElement(
              "span",
    ...
    save: ({ attributes }) => {
      return createElement(
        ...
        createElement(
          ...
          createElement(
            "a",
            { className: "blocoApps-link", href: attributes.link },
            attributes.cta
          ),
          createElement(
            "span",
      ...
      return createElement(
        ...
        createElement(
          ...
          createElement(
            ...
            createElement(
              "span",
              { className: "leiaTambem-t1" },
              attributes.title
            ),
            createElement(
              "div",
              { className: "leiaTambem-links" },
              ...links.map((link, index) =>
                createElement(
                  "a",
                  {
                    key: index,
                    href: link.url,
                    className: "block-leiaTambem-link",
                    target: "_blank",
                  },
                  link.titulo
                )
...
if (GProdemiSettings.blocks.faqBlock) {
  registerBlockType("gprodemi/faq-block", {
    ...
    attributes: {
      questions: {
        type: "array",
        default: [{ titulo: "Pergunta", answer: "Resposta" }],
      },
    },
        ...
        questions: [
          {
            ...
            answer:
              "Sim, esta é uma resposta de exemplo para mostrar como o bloco ficará.",
          },
          {
            titulo: "Posso adicionar mais de uma?",
            answer:
              "Com certeza! O preview mostrará todos os itens que você colocar aqui.",
          },
        ],
      },
    },
    ...
    edit: ({ attributes, setAttributes, clientId }) => {
      ...
      const addQuestion = () => {
        setAttributes({
          questions: [...questions, { titulo: "Pergunta", answer: "Resposta" }],
        });
      };
      ...
      return createElement(
        ...
        createElement(
          ...
          createElement(
            "div",
            { className: "faq-container", "data-faq-container": true },
            ...questions.map((quest, index) =>
              createElement(
                "details",
  ...
  registerBlockType("gprodemi/soccer-block", {
    ...
    attributes: {
      ...
      team_placeholder: {
        type: "string",
        default:
          "https://bjjl.smoothcomp.com/build/webpack/img/placeholder-image-logo-darker.98a13d685c449351f91f..png",
      },
    },
    ...
    edit: function ({ attributes, setAttributes, clientId }) {
      ...
      useEffect(() => {
        ...
        const timeout = setTimeout(() => {
          fetch(
            `${
              GProdemiSettings.blocks.soccerBlockUrl
            }/teams?name=${encodeURIComponent(search)}`
          )
            .then((res) => res.json())
            .then((data) => {
      ...
      return createElement(
        ...
        createElement(
          "div",
          {
            className: "block-soccer-block",
            "team-soccer-block": attributes.team,
          },
          createElement(
            "div",
            { className: "soccer-block-team" },
            createElement("img", { src: attributes.team_placeholder }),
            createElement("p", {}, team_name || "Casa")
          ),
          createElement(
            "div",
            { className: "soccer-block-score" },
            createElement(
              "span",
              { className: "soccer-block-score-date" },
            ...
            createElement(
              "div",
              { className: "soccer-block-score-content" },
              createElement("p", {}, "0 - 0"),
    ...
    save: ({ attributes }) => {
      return createElement("div", {
        className: "soccer-block",
        "data-team-id": attributes.team,
        style: { display: "none" },
      });
    },
  });
